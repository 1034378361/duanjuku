      ...
      await new Promise((resolve, reject) => {
        ...
        try {
          if (plan.player === 'hls' && !nativeHls) {
            ...
            hls = new Hls({enableWorker: true, lowLatencyMode: false, maxBufferLength: 30, maxMaxBufferLength: 60, backBufferLength: 20,
              manifestLoadingMaxRetry: 1, levelLoadingMaxRetry: 1, fragLoadingMaxRetry: 1, startPosition: Math.max(0, Number(offset) || 0)});
